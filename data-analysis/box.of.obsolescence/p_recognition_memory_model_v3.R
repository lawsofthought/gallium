...
M <- parallel.initialize(the.cluster, job.parameters, 'jags/recognition_memory_model_v3.jags', n.iterations)
...
save('data', 'M', 'S', 'D', 'the.seed', 'n.iterations',
     file = file.path(cache.directory, 
                      sprintf('mcmc_recognition_model_v3_seed_%d_iterations_burn_%d_sample_%d_dic_%d_date_%s.Rda',
                              the.seed,
                              n.iterations,
                              n.iterations,
                              n.iterations,
